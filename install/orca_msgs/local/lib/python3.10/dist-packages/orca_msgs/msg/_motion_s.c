...
bool orca_msgs__msg__effort__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * orca_msgs__msg__effort__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool orca_msgs__msg__motion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("orca_msgs.msg._motion.Motion", full_classname_dest, 28) == 0);
  }
  orca_msgs__msg__Motion * ros_message = _ros_message;
  {  // header
  ...
  {  // accel_model
    PyObject * field = PyObject_GetAttrString(_pymsg, "accel_model");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__accel__convert_from_py(field, &ros_message->accel_model)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // accel_drag
    PyObject * field = PyObject_GetAttrString(_pymsg, "accel_drag");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__accel__convert_from_py(field, &ros_message->accel_drag)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // accel_total
    PyObject * field = PyObject_GetAttrString(_pymsg, "accel_total");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__accel__convert_from_py(field, &ros_message->accel_total)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // vel
    ...
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->vel)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // effort
    ...
    if (!orca_msgs__msg__effort__convert_from_py(field, &ros_message->effort)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * orca_msgs__msg__motion__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("orca_msgs.msg._motion");
  ...
  {  // accel_model
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel__convert_to_py(&ros_message->accel_model);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "accel_model", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // accel_drag
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel__convert_to_py(&ros_message->accel_drag);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "accel_drag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // accel_total
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel__convert_to_py(&ros_message->accel_total);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "accel_total", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // vel
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->vel);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // effort
    PyObject * field = NULL;
    field = orca_msgs__msg__effort__convert_to_py(&ros_message->effort);
    if (!field) {
      return NULL;
    }
    {
