...
bool orca_msgs__msg__effort__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("orca_msgs.msg._effort.Effort", full_classname_dest, 28) == 0);
  }
  orca_msgs__msg__Effort * ros_message = _ros_message;
  {  // force
...
{
  /* NOTE(esteve): Call constructor of Effort */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("orca_msgs.msg._effort");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Effort");
